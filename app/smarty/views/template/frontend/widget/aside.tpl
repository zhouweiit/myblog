...
<div class="tj_news">
	...
	<div class="archive">
		<div class="archive_date">
			{%foreach from=$aside.archiveInfo.date item=info key=date%} <a
				href="/index/index?date={%$info.date%}">{%$date%}（{%$info.times%}）</a>
			{%/foreach%}
		</div>
		<div class="archive_category">
			{%foreach from=$aside.archiveInfo.category item=info%} <a
				href="/index/index?categoryid={%$info.category_id%}">{%$info.category_name%}（{%$info.times%}）</a>
			{%/foreach%}
		</div>
		<div class="clear"></div>
	</div>
...
<div class="ph_news">
	...
	<ul class="pl_n">
		...
		<dl>
			...
			<dd>
				<a href="/article/info?articleid={%$comment.article_id%}#comment">{%$comment.content%}</a>
			</dd>
		</dl>
		{%/foreach%}
	</ul>
...
<div class="ph_news">
	...
	<ul class="pl_n">
		<dl>
			<dd>
				<a href="mailto:zhouwei_work@163.com">邮箱：zhouwei_work@163.com</a>
			</dd>
			<dd>
				<a href="https://github.com/zhouweiit">github：github.com/zhouweiit</a>
			</dd>
		</dl>
	</ul>
</div>
