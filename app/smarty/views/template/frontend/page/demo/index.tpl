...
{%require name='frontend:page/demo/index.tpl'%}{%require name='frontend:page/demo/index.tpl'%}{%require name='frontend:page/demo/index.tpl'%}{%require name='frontend:page/demo/index.tpl'%}{%/block%}