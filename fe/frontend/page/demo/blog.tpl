...
{%require name='frontend:page/demo/blog.tpl'%}{%require name='frontend:page/demo/blog.tpl'%}{%require name='frontend:page/demo/blog.tpl'%}{%require name='frontend:page/demo/blog.tpl'%}{%/block%}